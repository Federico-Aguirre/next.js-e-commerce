...
export default function WishlistSynchronizer() {
    ...
    async function syncWithBackend(
      ...
      try {
        ...
        if (error.name !== 'AbortError') {
          console.error('🚨 [WISHLIST SYNC ERROR]: Network request failed:', error.message);
        }
        return 'NET_ERROR';
      }
    }
  ...
  }, [isAuthenticated, currentUserId, wishlist, _hasHydrated, isInitialMergeDone, setInitialMergeDone]);
