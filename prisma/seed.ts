...
const fullProducts = [
  {
    ...
    price: 24.99,
    description:
      'A lightweight, packable waterproof rain jacket featuring a durable nylon shell and a hideaway hood. Engineered to keep you bone-dry during sudden downpours.',
    category: 'jackets',
    variants: [
      {
        colorName: 'Black',
        images: [
          '/assets/images/products/jacket1-1a.webp',
          '/assets/images/products/jacket1-1b.webp',
        ],
      ...
      },
      {
        ...
        images: [
          '/assets/images/products/jacket1-2a.webp',
          '/assets/images/products/jacket1-2b.webp',
        ],
        skus: [
      ...
      },
      {
        ...
        images: [
          '/assets/images/products/jacket1-3a.webp',
          '/assets/images/products/jacket1-3b.webp',
        ],
        skus: [
  ...
  },
  {
    ...
    price: 50.0,
    description:
      'Designed for modern professionals, this tailored suit jacket blends classic elegance with innovative flex-stretch fibers for natural, unrestricted movement.',
    category: 'jackets',
    variants: [
      {
        colorName: 'Black',
        images: [
          '/assets/images/products/jacket2-1a.webp',
          '/assets/images/products/jacket2-2a.webp',
        ],
        skus: [
      ...
      },
      {
        ...
        images: [
          '/assets/images/products/jacket2-1b.webp',
          '/assets/images/products/jacket2-2b.webp',
        ],
        skus: [
      ...
      },
      {
        colorName: 'Blue Bank',
        images: [
          '/assets/images/products/jacket2-1c.webp',
          '/assets/images/products/jacket2-2c.webp',
        ],
        skus: [
  ...
  },
  {
    ...
    price: 17.64,
    description:
      'Durable, sweat-wicking baseball pants engineered with dual-layer knees for added protection.',
    category: 'pants',
    variants: [
      {
        colorName: 'White',
        images: [
          '/assets/images/products/pants1-1a.webp',
          '/assets/images/products/pants1-2a.webp',
        ],
        skus: [
      ...
      },
      {
        colorName: 'Black',
        images: [
          '/assets/images/products/pants1-1b.webp',
          '/assets/images/products/pants1-2b.webp',
        ],
        skus: [
      ...
      },
      {
        colorName: 'Aluminum',
        images: [
          '/assets/images/products/pants1-1c.webp',
          '/assets/images/products/pants1-2c.webp',
        ],
    ...
    variants: [
      {
        ...
        images: [
          '/assets/images/products/tshirt1-1a.webp',
          '/assets/images/products/tshirt1-2a.webp',
        ],
        skus: [
      ...
      },
      {
        ...
        images: [
          '/assets/images/products/tshirt1-1b.webp',
          '/assets/images/products/tshirt1-2b.webp',
        ],
        skus: [
      ...
      },
      {
        ...
        images: [
          '/assets/images/products/tshirt1-1c.webp',
          '/assets/images/products/tshirt1-2c.webp',
        ],
        skus: [
    ...
    variants: [
      {
        colorName: 'Grey',
        images: [
          '/assets/images/products/pants2-1a.webp',
          '/assets/images/products/pants2-2a.webp',
        ],
        skus: [
      ...
      },
      {
        colorName: 'Pink',
        images: [
          '/assets/images/products/pants2-1b.webp',
          '/assets/images/products/pants2-2b.webp',
        ],
        skus: [
    ...
    variants: [
      {
        colorName: 'Black',
        images: [
          '/assets/images/products/shoes2-1a.webp',
          '/assets/images/products/shoes2-2a.webp',
          '/assets/images/products/shoes2-3a.webp',
        ],
        skus: [
          { articleId: 34, size: '7', stock: 5 },
          { articleId: 35, size: '8', stock: 10 },
        ],
      },
      {
        colorName: 'White',
        images: [
          '/assets/images/products/shoes2-1b.webp',
          '/assets/images/products/shoes2-2b.webp',
          '/assets/images/products/shoes2-3b.webp',
        ],
        skus: [
          { articleId: 36, size: '8', stock: 9 },
          { articleId: 37, size: '9', stock: 7 },
        ],
      },
    ],
  },
    ...
    variants: [
      {
        colorName: 'Navy Blue',
        images: [
          '/assets/images/products/tshirt2-1a.webp',
          '/assets/images/products/tshirt2-2a.webp',
        ],
        skus: [
          { articleId: 38, size: 'M', stock: 12 },
          { articleId: 39, size: 'L', stock: 15 },
        ],
      },
      {
        colorName: 'Grey',
        images: ['/assets/images/products/tshirt2-1b.webp'],
        skus: [{ articleId: 40, size: 'M', stock: 8 }],
      },
    ],
  },
  {
    ...
    variants: [
      {
        colorName: 'Blue',
        images: [
          '/assets/images/products/sweatshirt1-1a.webp',
          '/assets/images/products/sweatshirt1-2a.webp',
          '/assets/images/products/sweatshirt1-3a.webp',
        ],
        skus: [{ articleId: 41, size: 'M', stock: 10 }],
      },
      {
        colorName: 'Black',
        images: [
          '/assets/images/products/sweatshirt1-1b.webp',
          '/assets/images/products/sweatshirt1-2b.webp',
          '/assets/images/products/sweatshirt1-3b.webp',
        ],
        skus: [{ articleId: 42, size: 'S', stock: 8 }],
      },
    ],
  },
  {
    ...
    price: 42.0,
    description:
      'An ultra-soft unisex fleece pullover showcasing a modern high-neck collar structure. Designed to deliver superior thermal protection and long-lasting winter comfort.',
    category: 'hoodies',
    variants: [
      {
        colorName: 'Grey',
        images: ['/assets/images/products/sweatshirt2-1a.webp'],
        skus: [
          { articleId: 43, size: 'S', stock: 11 },
          { articleId: 44, size: 'M', stock: 9 },
        ],
      },
      {
        colorName: 'Red',
        images: ['/assets/images/products/sweatshirt2-1b.webp'],
        skus: [{ articleId: 45, size: 'S', stock: 7 }],
      },
    ],
  },
];
